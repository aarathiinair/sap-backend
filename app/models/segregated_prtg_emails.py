...
class SegregatedPRTGEmail(Base):
    __tablename__ = 'segregated_prtg_email'
    ...
    sensor = Column(String(255), nullable=True)
    ...
    raw_email = relationship("RawEmail", back_populates="segregation_prtg")
    
    def __repr__(self):
        return f"<SegregatedPRTGEmail(id='{self.email_id[:10]}...', type='{self.type}')>"