...
class SegregatedGMSEmail(Base):
    __tablename__ = 'segregated_gms_email'
    ...
    raw_email = relationship("RawEmail", back_populates="segregation_gms")
    
    def __repr__(self):
        return f"<SegregatedGMSEmail(id='{self.email_id[:10]}...', type='{self.type}')>"