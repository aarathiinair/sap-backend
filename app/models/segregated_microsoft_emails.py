...
class SegregatedMicrosoftEmail(Base):
    __tablename__ = 'segregated_microsoft_email'
    ...
    raw_email = relationship("RawEmail", back_populates="segregation_microsoft")
    
    def __repr__(self):
        return f"<SegregatedMicrosoftEmail(id='{self.email_id[:10]}...', type='{self.type}')>"